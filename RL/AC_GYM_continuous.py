...
class Agent:
    ...
    def save(self):
        ...
        if not os.path.exists(path):
            os.makedirs(path)
        tl.files.save_npz_dict(self.actor.model.trainable_weights, name=os.path.join(path, 'model_actor.npz'))
        tl.files.save_npz_dict(self.critic.model.trainable_weights, name=os.path.join(path, 'model_critic.npz'))
